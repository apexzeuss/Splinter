      ...
      {showLogs && (
        <div className="h-44 bg-[#070709] border-b border-zinc-800 p-3 overflow-y-auto font-mono text-[11px] space-y-1.5 shadow-inner">
          <div className="flex items-center justify-between text-zinc-400 pb-1 border-b border-zinc-800/80 mb-2">
            <span className="font-semibold text-zinc-300">Splinter Runtime Event Console</span>
      ...
      <div className="px-4 sm:px-6 py-3 border-b border-zinc-800/50 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-zinc-400 font-sans">
        <div className="flex items-center gap-3 flex-wrap justify-center md:justify-start">
          <div className="flex items-center gap-1.5 text-zinc-200 font-semibold">
            ...
            <span>Splinter Climate Resilience</span>
          </div>
          ...
          <div className="bg-[#121217] border border-zinc-800 rounded-2xl max-w-lg w-full p-6 text-zinc-200 shadow-2xl relative space-y-4">
            ...
            {activeTrustModal === 'privacy' && (
              <div className="space-y-3">
                ...
                <p className="text-xs text-zinc-300 leading-relaxed">
                  Splinter operates under a strict <b>client-side privacy-first architecture</b>. When you use your device's GPS or search for a location, coordinate calculations are handled directly in your browser or sent exclusively to open, privacy-preserving geocoding APIs.
                </p>
            ...
            {activeTrustModal === 'terms' && (
              <div className="space-y-3">
                ...
                <p className="text-xs text-zinc-300 leading-relaxed">
                  Splinter routes are computed using geometric solar shadow projections ($L = H / \tan(\alpha)$) combined with street orientations and real-time Open-Meteo atmospheric telemetry.
                </p>
            ...
            {activeTrustModal === 'about' && (
              <div className="space-y-3">
                ...
                <p className="text-xs text-zinc-300 leading-relaxed">
                  Splinter is built entirely with open data standards:
                </p>
