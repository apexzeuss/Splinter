      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm sm:text-base text-zinc-400 max-w-3xl leading-relaxed">
            Standard navigation algorithms calculate only Euclidean or shortest-distance paths—funneling pedestrians onto unshaded, heat-absorbing asphalt during peak solar hours. Splinter computes the true physical trajectory of sunlight, direct irradiance, and sidewalk shade coverage.
          </p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-[#121216] border border-zinc-800 space-y-4">
          ...
          <div className="p-4 bg-zinc-900 rounded-2xl border border-zinc-800 flex items-center justify-between">
            <div className="text-xs text-zinc-300">
              Splinter adheres to the <strong>Universal Thermal Climate Index (UTCI)</strong> and WMO Urban Microclimate Standards.
            </div>
